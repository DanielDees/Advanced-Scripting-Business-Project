...
<div id="div-section-holder">
	<form action="" method="post">
        ...
        <div class="col-md-12">
        <h3>Article Title:</h3>
        <textarea name="arttitle" class="tinymce-100" rows="1" cols="100" required></textarea>
      <br>
	    <h3>Content:</h3>
      <textarea name="artcontent" class="tinymce-300" rows="4" cols="100" required></textarea>
	    <br>
      <h3>More Forms Here:</h3>
      <textarea name="art" class="tinymce" rows="1" cols="100" required></textarea>
	    <br>
	    <br>
