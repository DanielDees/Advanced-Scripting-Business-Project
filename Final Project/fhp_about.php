...
<main>
	<div id="div-section-holder">
		<h1 id="section-name">About Freedom's Hill Primer</h1>
	...
	<div id="div-section-holder">
		<h1 id="section-name">David Stubblefield, A.B.D.</h1>
		<h1 id="section-title">Senior Editor</h1>
		<p id="section-about">
	...
	<div id="div-section-holder">
		<h1 id="section-name">Chad Chisholm, Ph.D.</h1>
		<h1 id="section-title">Director</h1>
		<p id="section-about">
	...
	<div id="div-section-holder">
		<h1 id="section-name">Lewis Knight, Ph.D.</h1>
		<h1 id="section-title">Senior Producer</h1>
		<p id="section-about">
